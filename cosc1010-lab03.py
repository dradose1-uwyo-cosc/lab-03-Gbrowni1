...
# Lab 03 
# Lab Section: 
# Sources, people worked with, help given to: Ben(TA)= "Rockstar"
# Comments
...
print("Part One------------------------------------------------------------------------")
#We are going to start with the basics. Declare a list that states that contains the elements: Wyoming, Colorado, Montana in that order 
